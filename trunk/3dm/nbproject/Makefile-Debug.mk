...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/3dm

dist/Debug/GNU-Linux-x86/3dm: ${OBJECTFILES}
...
${OBJECTDIR}/m3dmgAdapter.o: nbproject/Makefile-${CND_CONF}.mk m3dmgAdapter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/m3dmgAdapter.o m3dmgAdapter.cpp

${OBJECTDIR}/m3dmgUtils.o: nbproject/Makefile-${CND_CONF}.mk m3dmgUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/m3dmgUtils.o m3dmgUtils.cpp

${OBJECTDIR}/m3dmgSerialLinux.o: nbproject/Makefile-${CND_CONF}.mk m3dmgSerialLinux.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/m3dmgSerialLinux.o m3dmgSerialLinux.cpp

${OBJECTDIR}/m3dmg.o: nbproject/Makefile-${CND_CONF}.mk m3dmg.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/m3dmg.o m3dmg.cpp
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/3dm
